...
<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="<?= base_url()?>/talanta/assets/img/favicon.ico">
  ...
  <br>
  	...
  	<h2 class="text-center" style="color: red;">Oops! That page can’t be found.</h2>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4">
                                    <div class="footer-wrapper ml-60 mb-30">
                                        ...
                                        <div class="footer-menu">
                                            <ul>
                                                <li><a href="<?= base_url('aboutus')?>"><i class="far fa-angle-right"></i> About Company</a></li>
                                                ...
                                                <li><a href="<?= base_url('advisory-services')?>"><i class="far fa-angle-right"></i>Advisory Services</a></li>
                                                 <li><a href="<?= base_url('advisory-services')?>"><i class="far fa-angle-right"></i>Skills and Enterprise</a></li>
                                                <li><a href="<?= base_url('trainings')?>"><i class="far fa-angle-right"></i>Online Training</a></li>
                                    ...
                                    <div class="footer-wrapper mb-30">
                                        ...
                                        <div class="recent-news">
                                            <div class="recent-news-text">
                                               ...
                                               <p>Talanta International is a professional services firm based in Dar-es-salaam,Tanzania,offering consulting and research services in East Africa.The company services can be categorized into three main areas:policy research,advisory services and skills and enterprise development services </p>
                                            </div>
