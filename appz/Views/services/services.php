      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <button type="button" name="add_record" id="add_record" class="btn btn-success btn-lg">Add Service</button>
          </div>
                <table id="category_table" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <tbody>
                      ...
                      <tr>
                         <td><?php echo $sn++; ?></td>
                        <td><img src="<?= base_url('uploads/services_image/'.$cat['image']) ?>" alt="image" width="50px" height="50px"></td> 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <span id="service_title_error" class="text-danger"></span>
          </div>
          </div>
          <div class="col-sm-6">
         <div class="form-group">
           ...
           <div class="form-group">
            <label>Service Description</label>
             <textarea class="form-control summernote" rows="5" name="service_description" id="service_description" value=""></textarea>
            <span id="service_description_error" class="text-danger"></span>
          </div>
 ...
 $('#user_form').on('submit', function(event){
    ...
    $.ajax({
      ...
      success:function(data)
      {
        ...
        if(data.error == 'yes')
        {
          ...
          $('#service_title_error').text(data.service_title_error);


          $('#service_description_error').text(data.service_description_error);
  ...
  $(document).on('click', '.edit', function(){
    ...
    $.ajax({
      ...
      url:"services/fetch_single_service",
      ...
      success:function(data)
      {
        ...
        $('#service_title').val(data.service_title);
         ...
         $('#service_description').summernote('code',data.service_description);

        $('#user_image').html(data.service_image);
