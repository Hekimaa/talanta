...
<head>
        ...
        <title>Talanta International-Fresh Ideas</title>
    ...
    <!-- preloader end  -->
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="<?= base_url('/')?>">Services <i class="far fa-angle-down"></i></a>
                                            <ul class="sub-menu text-left">
                                                ...
                                                <li><a href="<?= base_url('skills-and-enterprise-development')?>">Skills & Enterprise Development</a></li>
                                                 <li><a href="<?= base_url('trainings')?>">Virtual Training</a></li>
                                                 <li><a href="<?= base_url('preschedule')?>">Face To Face Training</a>
                    ...
                    <div id="rs_slider_01" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                        <ul>
                            ...
                            <li data-index="rs-01" data-transition="random" data-slotamount="default" data-hideafterloop="0"
                                ...
                                data-thumb="<?= base_url()?>/talanta/assets/img/slider/s1.jpg" data-rotate="0" data-saveperformance="off"
                                ...
                                <div class="tp-caption rev_group" id="rs-layer-01" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption NotGeneric-Title  tp-resizeme" id="rs-layer-02"
                                        ...
                                        data-fontsize="['60', '60', '50', '35']" data-lineheight="['70', '70', '60', '45']"
                                        style="z-index: 7;white-space: normal; font-size: 60px; line-height: 60px; font-weight: 800; color: #222; letter-spacing: 0px;font-family:'Montserrat', sans-serif;">
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="rs-layer-03"
                                        ...
                                        style="z-index: 9; white-space: normal; font-size: 18px; line-height: 30px; color: #222;font-family:'Montserrat', sans-serif;font-weight: 600;">
                                        Were are experts on designing,managing and undertaking economic development 
                                    </div>
                                </div>
                                <!-- LAYER NR. 1 -->
                                ...
                                <div class="tp-caption  " id="rs-layer-04" data-x="['left','left','left','left']"
                                    ...
                                    <div class="bd-slider-button">
                                        <a class="btn-icon" href="<?= base_url('policy-research')?>">Learn More <i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </li>
                            <!-- SLIDE 02 -->
                            <li data-index="rs-02" data-transition="random" data-slotamount="default" data-hideafterloop="0"
                                data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
                                data-thumb="<?= base_url()?>/talanta/assets/img/slider/s3.JPG" data-rotate="0" data-saveperformance="off" data-title="Slide"
                                ...
                                <div class="tp-caption rev_group" id="rs-layer-01-2" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption   tp-resizeme" id="rs-layer-03-2" data-x="['left','left','left','left']"
                                        ...
                                        data-paddingleft="[0,0,0,0]" data-fontsize="['18', '19', '20', '16']"
                                        style="z-index: 9; white-space: normal; font-size: 18px; line-height: 30px; color: #222;font-family:'Montserrat', sans-serif;font-weight: 600;">
                                       Talanta International promotes development and growth of small businesses(start_up).
                                    </div>
                                </div>
                                <!-- LAYER NR. 1 -->
                                ...
                                <div class="tp-caption  " id="rs-layer-04-2" data-x="['left','left','left','left']"
                                    ...
                                    style="z-index: 5; white-space: normal; font-size: 20px; line-height: 22px; font-weight: 400; color: #444; letter-spacing: 0px;font-family:'Montserrat', sans-serif;">
                                    <div class="bd-slider-button">
                                        <a class="btn-icon" href="<?= base_url('trainings')?>">Learn More <i class="far fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                            </li>
        ...
        <!-- services-area-start -->
         <?php if($preschedules): ?>
            <div class="services-area pb-130 grey-bg pt-125">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 offset-lg-3 offset-xl-3">
                            <div class="area-title text-center mb-75 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".3">
                                <h1>Our Face to Face Training</h1>
                                <p style="text-align:justify;">Talanta International designs and delivers training solutions to individuals, companies and organizations. Training services are available on a wide range of areas.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row services-active wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".3">
                        ...
                        <div class="col-xl-12">
                            <div class="services-wrapper white-bg">
                                <div class="services-img pos-rel">
                                    <div class="fix">
                                      <img src="<?= base_url('uploads/preschedules_image/'.$cat['preschedules_image']) ?>" alt="image" width="300px" height="300px">
                                    </div>
                                    <div class="services-img-icon">
                                      <i class="flaticon-team-1"></i>
                                    </div>
                                ...
                                <div class="services-text">
                                    <h4><?= $cat['preschedules_title']?></h4>
                                  
                                </div>
                                <div class="services-button">
                                    <a href="<?= $cat['preschedules_url']?>">Learn More <i class="far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 offset-lg-2 offset-xl-2">
                            <div class="brand-title text-center mb-75">
                                ...
                                <p style="text-align:justify;"> Talanta International has successfully built a strong partnerships and a trusted working relationship with a growing number of local and international clients including (but not limited to):
                                    </p>
                            </div>
                        </div>
                    </div>
                    <div class="row brand-active">
                            ...
                            <div class="brand-img text-center">
                                <img src="<?= base_url('uploads/clients_image/'.$cat['client_image']) ?>" alt="image" style="width:80%">
                            </div>
            ...
            <!-- brand-area-end -->
             <!-- quote-area-start -->
            <div class="quote-area pt-125 quote-padding" style="background-image:url(<?= base_url('talanta/assets/img/bg/bg-4.jpg')?>)">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8 col-lg-8 offset-lg-2 offset-xl-2">
                            <div class="area-title-blue area-title-white text-center ml-50 mr-50 mb-80 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".3" >
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="quote-wrapper">
                                <form id="quote-form" action="<?= base_url('messages')?>"  method="post">
                                    <div class="row">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="quote-btn text-center">
                                                <button class="btn btn-warning" type="submit">submit message <i class="far fa-long-arrow-right">
                                                </i></button>
                                            </div>
                                        </div>
                                    </div>
 ...
 <!-- footer-area-start -->
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4">
                                    <div class="footer-wrapper mb-30">
                                        <div class="footer-logo">
                                            <a href="<?= base_url('/')?>"><img src="<?= base_url()?>/talanta/assets/img/logo/logo.png" alt=""></a>
                                        </div>
                                        ...
                                        <div class="footer-menu">
                                            <ul>
                                                ...
                                                <li><a href="<?= base_url('advisory-services')?>"><i class="far fa-angle-right"></i>Advisory Services</a></li>
                                                 <li><a href="<?= base_url('advisory-services')?>"><i class="far fa-angle-right"></i>Skills and Enterprise Development</a></li>
                                                <li><a href="<?= base_url('trainings')?>"><i class="far fa-angle-right"></i>Virtual Training</a></li>
                                                <li><a href="<?= base_url('preschedule')?>"><i class="far fa-angle-right"></i>Face to Face Training </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="footer-wrapper mb-30">
                                        ...
                                        <div class="recent-news">
                                            <div class="recent-news-text">
                                               ...
                                               <p style="text-align:justify;">Talanta International is a professional services firm based in Dar-es-salaam, Tanzania, offering consulting and research services in East Africa.</p>
                                            </div>
        ...
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.actions.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.carousel.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.kenburn.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.migration.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.navigation.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.parallax.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript" src="<?= base_url()?>/talanta/assets/rs/js/extensions/revolution.extension.video.min.js"></script>
    </body>
