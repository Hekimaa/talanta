...
<head>
        ...
        <title>POLICY RESEARCH | Talanta International-Fresh Ideas</title>
    ...
    <!-- preloader end  -->
        ...
        <main>
            ...
            <div class="breadcrumb-area pt-70 pb-70"  style="height:5px; background-image:url(<?= base_url('talanta/assets/img/bg/about.jpg')?>); ">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-9 mb-30">
                            <div class="blog-wrapper mb-60">
                                <div class="blog-img">
                                    <img src="<?= base_url('uploads/services_image/'.$policy['image']) ?>" alt="" style="width:800px; height:400px;">
                                </div>
                                <div class="blog-text blog-02-text">
                                   
                                    <h4 class="text-center"><?= $policy['title']?></h4>
...
<!-- Mirrored from www.devsnews.com/template/bizzix/bizzix/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 05 Nov 2020 09:17:42 GMT -->
</html>