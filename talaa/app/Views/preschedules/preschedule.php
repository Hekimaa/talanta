...
<head>
        ...
        <meta http-equiv="x-ua-compatible" content="ie=edge">
         <title>Talanta International-Fresh Ideas | Face to Face Trainings</title>
  ...
  <!-- header-start -->
        ...
        <main>
            ...
            <div class="breadcrumb-area pt-40 pb-40" style="background-image:url(<?= base_url('talanta/assets/img/bg/about.jpg')?>)">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="breadcrumb-text text-center">
                                <h1>FACE TO FACE TRAININGS</h1>
            ...
            <div class="case-study-area grey-2-bg pt-130 pb-130">
                <div class="container">
                    <div class="row ">
                            <?php if($preschedule){ ?>
                         <?php foreach($preschedule as $cat): ?>
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="case-study-wrapper case-study-blue-wrapper case-3-col mb-60 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".3">
                                <div class="case-study-img">
                                    <a href="<?= $cat['preschedules_url']?>"><img src="<?= base_url('uploads/preschedules_image/'.$cat['preschedules_image']) ?>" alt="image" width="300px" height="300px"></a>
                                </div>
                                <div class="case-study-text text-center">
                                    <h4><a href="<?= $cat['preschedules_url']?>"><?= $cat['preschedules_title']?></a></h4>
                                    <a href="<?= $cat['preschedules_url']?>">read more <i class="far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                          ...
                          <?php }else{
                            ...
                            ?>
                            <h2 class="text-center">No Face to Face Trainings  have been Uploaded</h2>
                            <?php
                          } ?>
                       ...
                       <div class="row">
                        <div class="col-xl-12">
                            <div class="case-button text-center">
                                <a class="btn" href="#">view all Trainings <i class="far fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="footer-wrapper mb-30">
                                        ...
                                        <div class="recent-news">
                                            <div class="recent-news-text">
                                               ...
                                               <p>Talanta International is a professional services firm based in Dar-es-salaam, Tanzania, offering consulting and research services in East Africa.</p>
                                            </div>
