...
<head>
        ...
        <title>Contacts Us ~ Talanta International-Fresh Ideas</title>
    ...
    <!-- preloader end  -->
                        ...
                        <div class="col-xl-9 col-lg-9">
                                ...
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="<?= base_url('/contacts')?>">Contact Us</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
        ...
        <main>
            ...
            <div class="breadcrumb-area pt-60 pb-60" style="background-image:url(<?= base_url('talanta/assets/img/bg/w.jpg')?>)">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4">
                            <div class="contact-box text-center mb-30 wow fadeInUp" data-wow-delay=".5s" data-wow-duration=".3">
                                ...
                                <h3>Visit Here</h3>
                                <p>6th Floor, Ngome Holding House
                                Mwenge, Africa Sana
                                P.O. BOX 33161 Kijitonyama<br> 
            ...
            <!-- map-area-start -->
           <div class="mapouter"><iframe width="1500" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Ngome,%20Africa%20Sana&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowfullscreen></iframe><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div>
            <!-- map-area-end -->
