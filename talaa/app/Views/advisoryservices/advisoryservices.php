...
<head>
        ...
        <title>ADVISORY SERVICES | Talanta International Fresh Ideas</title>
    ...
    <!-- preloader end  -->
        ...
        <!-- header-end -->
         <main>
            ...
            <div class="breadcrumb-area pt-80 pb-80"  style="height:5px; background-image:url(<?= base_url('talanta/assets/img/bg/advisory.jpg')?>); ">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-9 mb-30">
                            <div class="blog-wrapper mb-60">
                                <div class="blog-img">
                                    <img src="<?= base_url()?>/talanta/assets/img/bg/advisory.jpg" alt="" style="width:800px; height:300px;">
                                </div>
                                <div class="blog-text blog-02-text">
                                   
                                    <h4 class="text-center"><?= $advisory['title']?></h4>
