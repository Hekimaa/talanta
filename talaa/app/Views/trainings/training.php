...
<head>
        ...
        <meta http-equiv="x-ua-compatible" content="ie=edge">
         <title>Talanta International-Fresh Ideas | Virtual Trainings</title>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            <div class="case-study-wrapper case-study-blue-wrapper case-3-col mb-60 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".3">
                                <div class="case-study-img">
                                    <a href="<?= $cat['training_url']?>"><img src="<?= base_url('uploads/trainings_image/'.$cat['training_image']) ?>" alt="image" width="500px" height="300px"></a>
                                </div>
                                <div class="case-study-text text-center">
                                    <h4><a href="<?= $cat['training_url']?>"><?= $cat['training_title']?></a></h4>
                                    <a href="<?= $cat['training_url']?>">read more <i class="far fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                         <?php endforeach; ?>
                           <?php }else{
                            ...
                            ?>
                            <h2 class="text-center">No Virtual Trainings  have been Uploaded</h2>
                            <?php
                          } ?>
