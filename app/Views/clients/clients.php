      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <button type="button" name="add_record" id="add_record" class="btn btn-success btn-lg">Add Clients</button>
          </div>
                <table id="category_table" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <tbody>
                      ...
                      <tr>
                         <td><?php echo $sn++; ?></td>
                        <td><img src="<?= base_url('uploads/clients_image/'.$cat['client_image']) ?>" alt="image" width="50px" height="50px"></td> 
 ...
 $('#user_form').on('submit', function(event){
  ...
  $(document).on('click', '.edit', function(){
    ...
    $.ajax({
      ...
      url:"clients/fetch_single_client",
      ...
      success:function(data)
      {
        ...
        $('#user_image').html(data.client_image);
