      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <button type="button" name="add_record" id="add_record" class="btn btn-success btn-lg">Add Users</button>
          </div>
                  ...
                  <tr>
                    ...
                    <th>Action</th>
                      ...
                      <tr>
                        ...
                        <td><img src="<?= base_url('uploads/users/'.$cat['image']) ?>" alt="image" width="50px" height="50px"></td> 
        ...
        <div class="modal-body">
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <span id="user_images" class="text-danger "></span>
          </div>
          <div class="form-group">
            <label>Email</label>
